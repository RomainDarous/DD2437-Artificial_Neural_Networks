...
class RestrictedBoltzmannMachine:
    ...
    def cd1(self, visible_trainset, n_iterations=20):
        ...
        directory = f'./results/rbm/{self.ndim_hidden}'
        ...
        for it in range(n_iterations):
            ...
            if it % self.rf["period"] == 0 and self.is_bottom:
                ...
                viz_rf(weights=self.weight_vh[:, self.rf["ids"]].reshape(
                    (self.image_size[0], self.image_size[1], -1)), it=it, grid=self.rf["grid"], directory=directory)
            ...
            if it % self.print_period == 0:
                ...
                loss = mean_squared_error(visible_trainset, v)
    ...
    def get_h_given_v(self, visible_minibatch):
        ...
        h_prob = sigmoid(visible_minibatch @ self.weight_vh + self.bias_h)
    ...
    def get_v_given_h(self, hidden_minibatch):
        ...
        if self.is_top:
            ...
            v_prob = sigmoid(hidden_minibatch @ self.weight_vh.T + self.bias_v)
    ...
    def get_h_given_v_dir(self, visible_minibatch):
        ...
        # [TODO TASK 4.1] compute probabilities and activations (samples from probabilities) of hidden layer (replace the zeros below)
        h_prob = sigmoid(visible_minibatch @ self.weight_v_to_h + self.bias_h)
        h_act = sample_binary(h_prob)
    ...
    def get_v_given_h_dir(self, hidden_minibatch):
        ...
        if self.is_top:
            ...
            v_prob = sigmoid(hidden_minibatch @ self.weight_h_to_v + self.bias_v)
            v_act = sample_binary(v_prob)
